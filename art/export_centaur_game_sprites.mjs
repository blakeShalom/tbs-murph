...
const inputDir = path.join(rootDir, "img", "units", "centaurs");

const configs = [
  { id: "recon", source: "recon-source.png", output: "recon.png", labelCutoffY: 790 },
  { id: "brute", source: "brute-source.png", output: "brute.png", labelCutoffY: 790 },
  { id: "marksman", source: "marksman-source.png", output: "marksman.png", labelCutoffY: 790 },
  { id: "captain", source: "captain-source.png", output: "captain.png", labelCutoffY: 790 }
];
...
console.log(`Exported final centaur game sprites to ${inputDir}`);
